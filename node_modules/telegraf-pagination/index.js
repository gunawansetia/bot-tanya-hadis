class Pagination {
    defaultMessages = {
        firstPage: "❗️ Ini halaman pertama",
        lastPage: "❗️ Ini halaman terakhir",
        prev: "⬅️ Sebelumnya",
        next: "➡️ Berikutnya",
        delete: "❌ Hapus"
    };
    ...
    constructor({
        ...
        // header = (currentPage, pageSize, total) => `Item ${(currentPage - 1) * pageSize + 1}-${currentPage * pageSize <= total ? currentPage * pageSize : total} dari ${total}`,
        header = (currentPage, pageSize, total) => `Halaman ${(currentPage)} dari ${this.totalPages}`,
